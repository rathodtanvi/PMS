...
<head>
    ...
    * License: https://bootstrapmade.com/license/
    ...
    <aside id="sidebar" class="sidebar">
        ...
        <li class="nav-item">
            <a class="nav-link collapsed"  href="http://localhost:8080/API_PMS/public/AdminTechnology">
        ...
        <li class="nav-item">
            <a class="nav-link collapsed"  href="http://localhost:8080/API_PMS/public/AdminProject">
        ...
        <li class="nav-item">
            <a class="nav-link collapsed"  href="http://localhost:8080/API_PMS/public/AdminProjectAllotment">
