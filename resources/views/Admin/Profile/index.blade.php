...
@section('content')
<script src="{{ asset('pms.js') }}"></script>
                  ...
                  {{-- <form method="post" action="{{route('changepassword')}}"> --}}
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        ...
                        <h6 style="color:red;" class="err_current_password"></h6>
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        ...
                        <h6 style="color:red;" class="err_password"></h6>
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        ...
                        <h6 style="color:red;" class="err_confirm_password"></h6>
                      </div>
                    </div>
